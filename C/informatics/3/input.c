...
char InputInt(long* x, char size)
{
	char err = 0;
...
char InputInt32(int* x)
{
	long t = *x;
	char err = InputInt(&t, 32);
	*x = (int)t;
	return err;
}
char InputInt16(short* x)
{
	long t = *x;
